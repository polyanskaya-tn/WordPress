                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            ...
                                                            <div class="wrapper prev-indent-bot2">
                                                                <figure class="img-indent2 frame2"><img src="<?php bloginfo('template_url'); ?>/images/page2-img1.jpg" alt=""></figure>
            	...
            	<div class="container_12">
                	<div class="wrapper">
                        ...
                        <article class="grid_8">
                            ...
                            <div class="wrapper">
                            	<figure class="img-indent2 frame2"><img src="<?php bloginfo('template_url'); ?>/images/page2-img2.jpg" alt=""></figure>
                                <div class="extra-wrap">
